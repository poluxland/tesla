...
class SucursalesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sucursale" do
    assert_difference("Sucursale.count") do
      post sucursales_url, params: { sucursale: { cliente_id: @sucursale.cliente_id, contacto: @sucursale.contacto, direccion: @sucursale.direccion, nombre: @sucursale.nombre } }
    end
  ...
  test "should update sucursale" do
    patch sucursale_url(@sucursale), params: { sucursale: { cliente_id: @sucursale.cliente_id, contacto: @sucursale.contacto, direccion: @sucursale.direccion, nombre: @sucursale.nombre } }
